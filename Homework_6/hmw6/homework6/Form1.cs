...
namespace homework6
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            double[] avglistL = avglist.ToArray();

            double population_expected_value = compute_mean(avglistL);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            double[] variancelistL = variancelist.ToArray();


           
            double population_variance = compute_variance(variancelistL);
